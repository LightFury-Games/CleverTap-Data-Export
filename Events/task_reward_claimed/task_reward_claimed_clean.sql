CREATE OR REPLACE VIEW clevertap.task_reward_claimed_events AS
...
SELECT
    ...
    -- task_reward_claimed specific event properties
    ...
    element_at(eventProps, 'task_premium').member5
        AS task_premium,

    element_at(eventProps, 'task_points_earned').member5
...
FROM clevertap.task_reward_claimed;