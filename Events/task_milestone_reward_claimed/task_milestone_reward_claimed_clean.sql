CREATE OR REPLACE VIEW clevertap.task_milestone_reward_claimed_events AS
...
SELECT
    ...
    -- task_milestone_reward_claimed specific event properties
    element_at(eventProps, 'task_milestone_id').member5
        AS task_milestone_id,
...
FROM clevertap.task_milestone_reward_claimed;