CREATE OR REPLACE VIEW clevertap.network_error_events AS
...
SELECT
    ...
    -- network_error specific event properties
    element_at(eventProps, 'network_error_message').member5
        AS network_error_message,
