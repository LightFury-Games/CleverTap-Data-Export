CREATE OR REPLACE VIEW clevertap.ftueskip_events AS
...
SELECT
    ...
    -- ftueskip specific event properties
    element_at(eventProps, 'ftues_step_tag').member5
        AS ftues_step_tag,

    element_at(eventProps, 'CT Session Id').member1
        AS ct_session_id_event,
